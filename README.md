...
For further details see [docs page](docs/security-audit.md)

| Skill | Description |
|---|---|
| [`security-audit`](skills/security-audit/) | Threat-model-driven security audit, validation, exploit chaining, and `.security/` reporting |
