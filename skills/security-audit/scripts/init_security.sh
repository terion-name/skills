...
echo "       findings/     -> one finding per file (SEC-NNN-[SEVERITY]-[CWE-NNN-label]-slug.md), chronological IDs"
echo "       fixed/        -> remediated findings moved here, keeping original SEC-NNN IDs/filenames"
